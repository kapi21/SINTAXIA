...
1284 FOR B=1 TO LEN(M$):PRINT CHR$(8);" ";CHR$(8);:NEXT B
1286 RETURN
1290 REM backspace un caracter
...
3350 IF FAST%=0 AND C1$<>" " THEN SOUND 1,1200,1,1,0,0,1
3360 NEXT K%
3370 PRINT
3380 RETURN
...
6927 W%=0
6928 IF DR%=0 THEN SOUND 2,568,30,2,2,0,0:DR%=1:GOTO 6925
6929 SOUND 2,638,30,2,2,0,0:DR%=0:GOTO 6925
6930 IF K$<>" " THEN 6925
