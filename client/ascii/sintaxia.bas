...
140 IF K$<>"1" THEN 150
142 PRINT
144 PEN 3:PRINT "Seleccionado Modo 1..."
146 PRINT "Iniciando la aventura...":PEN 1
148 RUN"aventura
150 IF K$<>"2" THEN 160
152 PRINT
154 PEN 3:PRINT "Seleccionado Modo 2..."
156 PRINT "Iniciando la aventura...":PEN 1
158 RUN"aventuramode2
160 GOTO 130
